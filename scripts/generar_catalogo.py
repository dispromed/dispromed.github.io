...
# Botón flotante de WhatsApp — el mismo de la home, lo atiende comercial1.
# El glifo va INLINE y no como <use href="#whatsapp">: el <symbol> vive en el
# sprite de index.html, que es otro documento (ver SPRITE_FLECHA arriba).
ENLACE_WHATSAPP = (
    "https://wa.me/573174285502"
    "?text=Hola%20Dispromed%2C%20quisiera%20informaci%C3%B3n%20sobre%20sus%20productos."
)
GLIFO_WHATSAPP = (
...
BOTON_WHATSAPP = f"""<a class="wa-float" href="{ENLACE_WHATSAPP}" target="_blank" rel="noopener" aria-label="Escríbenos por WhatsApp">
  <svg viewBox="0 0 24 24" aria-hidden="true">{GLIFO_WHATSAPP}</svg>
  <span class="wa-float__tip">¿Hablamos por WhatsApp?</span>
</a>
"""
...
<link rel="stylesheet" href="../assets/css/main.css?v=15">{script}
...
"""
    ...
    return (
        ...
        # Arriba, en la cabecera, se vuelve a la página principal; el regreso al
        # catálogo completo va dentro del contenido, junto a lo que se está viendo.
        + _cabecera("Volver al inicio", "../index.html")
        + f"""
<main class="wrap doc" style="max-width:920px">
  <a class="btn btn--outline btn--sm cat-volver" href="index.html">‹ Ver todo el catálogo</a>
